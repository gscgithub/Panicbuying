...
public class MyEmail {
	...
	public static void main(String[] args) {
		try {
			sendMail("18947244682@163.com", "649466141a", "896312585@qq.com", 
					"smtp.163.com","mail content", "mail test");
		} catch (Exception e) {
	 ...
	 * @param sendEmailPasswor
	 * @param recEmailAccount
	 * @throws Exception 
	 */
	public static void sendMail(String sendEmailAccount, String sendEmailPasswor,
				String recEmailAccount, String smtpServiceAddress, String mailContent, 
				String subject) throws Exception {
		
		// 1. 创建参数配置, 用于连接邮件服务器的参数配置
		Properties props = new Properties(); // 参数配置
		props.setProperty("mail.transport.protocol", "smtp"); // 使用的协议（JavaMail规范要求）
		props.setProperty("mail.smtp.host", smtpServiceAddress); // 发件人的邮箱的 SMTP
																// 服务器地址
		...
		MimeMessage message = createMimeMessage(session, sendEmailAccount,
				recEmailAccount, mailContent, subject);
		...
		transport.connect(sendEmailAccount, sendEmailPasswor);
	...
	public static MimeMessage createMimeMessage(Session session, String sendMail,
			String receiveMail, String mailContent, String subject) throws Exception {
